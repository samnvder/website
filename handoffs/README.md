...
| **19** | **[membership-campaign-engine](membership-campaign-engine.md)** | ✅ **CLOSED 2026-08-24.** Campaign engine landed and proven on the real CRLF `Special Offer.html`. Sources parked (`OFFER NOT SET` / `UNSET-set-before-launch`). Summer 2026 archived as `2026-07-summer-special-100-enrollment-10-guest-passes`. Repo only — no live pastes. | — | done |

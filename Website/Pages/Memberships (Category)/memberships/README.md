...
3. **Go live** — paste the full contents of `membership builder JS.js` into WordPress
   WPCode snippet **#9926** (normal join page). Snippet **#7315** stays as discounted enrollment.

Pass only the types you want to change; omit the rest. Enrollment fees and F&B

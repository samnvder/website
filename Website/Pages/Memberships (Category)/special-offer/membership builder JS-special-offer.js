 ...
 * Offer: flat $100 enrollment + 10 guest passes through July 21, 2026 (midnight Pacific).
...
(function () {
    function initMembershipBuilder() {
        ...
        function updateEnrollmentFee() {
            ...
            if (limitedTimeText) {
                limitedTimeText.textContent = "through July 21 at midnight · 10 guest passes included";
